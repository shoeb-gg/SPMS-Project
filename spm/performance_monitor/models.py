...
class Cse303ObeMarkSheetAnalysis(models.Model):
    ...
    sectionid = models.CharField(db_column='sectionID', max_length=3, blank=True, null=True)  # Field name made lowercase.
    semester = models.CharField(max_length=8, blank=True, null=True)
    totalobtainedmarks_100_field = models.IntegerField(db_column='totalObtainedMarks(100)', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    passorfail = models.CharField(db_column='passOrFail', max_length=12, blank=True, null=True)  # Field name made lowercase.
    co1percentage = models.CharField(db_column='co1Percentage', max_length=27, blank=True, null=True)  # Field name made lowercase.
    co2percentage = models.CharField(db_column='co2Percentage', max_length=10, blank=True, null=True)  # Field name made lowercase.
    co3percentage = models.CharField(db_column='co3Percentage', max_length=3, blank=True, null=True)  # Field name made lowercase.
    co4percentage = models.CharField(db_column='co4Percentage', max_length=10, blank=True, null=True)  # Field name made lowercase.
    co1achievement = models.CharField(max_length=20, blank=True, null=True)
    ...
    plo2achievement = models.CharField(max_length=14, blank=True, null=True)
...
class Cse303ObeMarkSheetMarks(models.Model):
    ...
    midtermtotal_150_field = models.CharField(db_column='midtermTotal(150)', max_length=13, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    midtermtotalconverted_30_field = models.CharField(db_column='midtermTotalConverted(30)', max_length=23, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    ...
    finaltotal_100_field = models.CharField(db_column='finalTotal(100)', max_length=11, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    finaltotalconverted_40_field = models.CharField(db_column='finalTotalConverted(40)', max_length=21, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    projectworkmarks_30_field = models.CharField(db_column='projectWorkMarks(30)', max_length=12, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    ...
    co1totalobtained_165_field = models.CharField(db_column='co1TotalObtained(165)', max_length=8, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
...
class Cse303ObeMarkSheetVerdict(models.Model):
    ...
    outcomeachievedby = models.CharField(db_column='outcomeAchievedBy', max_length=21, blank=True, null=True)  # Field name made lowercase.
    outcomeachievedby_field = models.CharField(db_column='outcomeAchievedBy(%)', max_length=25, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    outcomefailedtoachieve = models.CharField(db_column='outcomeFailedToAchieve', max_length=17, blank=True, null=True)  # Field name made lowercase.
    outcomefailedtoachieve_field = models.CharField(db_column='outcomeFailedToAchieve(%)', max_length=21, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
